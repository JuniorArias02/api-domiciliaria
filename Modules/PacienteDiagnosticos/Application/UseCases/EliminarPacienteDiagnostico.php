...
class EliminarPacienteDiagnostico
{
    ...
    public function execute(int $id_paciente, string $codigo_cie10, string $tipo_diagnostico)
    {
        return $this->repo->eliminar($id_paciente, $codigo_cie10, $tipo_diagnostico);
    }
}
